...
import { createDmOpenLoop, deleteDmOpenLoop, fetchDmOpenLoops, updateDmOpenLoop } from "@/lib/services/dm"
...
export function OpenLoopsSection() {
  ...
  const handleToggleCreateForm = useCallback(() => {
    ...
    setEditingLoopId(null)
    setIsFormOpen(true)
  }, [editingLoopId, isFormOpen, resetForm])
    ...
    <div className="space-y-6">
      <section className="rounded-md border border-border bg-card p-4 shadow-sm">
        <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
          ...
          <Button type="button" onClick={handleToggleCreateForm}>
        ...
        {isLoading ? (
          <DmSectionMessage>Cargando Open Loops...</DmSectionMessage>
          ...
          <div className="space-y-4">
            {filteredLoops.map((loop) => {
              const updatedLabel = formatDmTimestamp(loop.updatedAt ?? loop.createdAt)
