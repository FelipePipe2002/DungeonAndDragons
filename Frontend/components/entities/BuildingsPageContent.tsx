...
import { ArrowRight, Building2, MapPin, Plus, Shield, User } from "lucide-react"
...
export function BuildingsPageContent({ showHeader = true, loadRelatedData = true }: BuildingsPageContentProps) {
  ...
  return (
    <div className="mx-auto max-w-[1600px] px-6 py-8">
        ...
        {filteredBuildings.map((building) => (
          ...
          >
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1.5">
              ...
              <MentionField source="auto" value={building.descripcion} editable={false} className="line-clamp-2 text-xs leading-relaxed text-muted-foreground" emptyText="" />
      ...
      {filteredBuildings.length === 0 ? <p className="mt-6 text-center text-sm text-muted-foreground">No hay edificios que coincidan.</p> : null}
