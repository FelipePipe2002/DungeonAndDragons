...
## Token Format
- Mention tokens look like: `@[Label](type:id)` where type is `landmark|building|character|organization`.

## Data and Props Expectations
- `source="auto"` triggers fetch of landmarks/buildings/characters/organizations.
