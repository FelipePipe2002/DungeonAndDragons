...
import { createDmRelationship, deleteDmRelationship, fetchDmRelationships, updateDmRelationship } from "@/lib/services/dm-relationships-api.service"
import { fetchRelationshipEntityOptions, type RelationshipEntityOption } from "@/lib/dm-relationships/entity-options"
import { DM_RELATIONSHIPS_CHANGED_EVENT, openCreateDmRelationshipDialog } from "@/lib/navigation/global-create-events"
...
function formatRelationshipTimestamp(value?: string) {
      ...
      <section className="space-y-4">
        ...
        {isLoading ? (
          ...
          <div className="rounded-md border border-dashed border-border bg-background/80 p-6 text-sm text-muted-foreground">
            No hay relaciones guardadas todavia.
          </div>
        ) : (
          relationships.map((relationship) => {
            ...
            const updatedAt = formatRelationshipTimestamp(relationship.updatedAt ?? relationship.createdAt)
